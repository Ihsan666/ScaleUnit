        ...
        this.transactionList = this.context.controlFactory.create<Entities.LegacySalesTransaction>(
            ...
            "DataList",
            {
                columns: [
                    {
                        collapseOrder: 8,
                        computeValue: (line: Entities.LegacySalesTransaction): string => { return emptyIfNull(line.Description); },
                    ...
                    {
                        collapseOrder: 7,
                        computeValue: (line: Entities.LegacySalesTransaction): string => { return emptyIfNull(line.Quantity.toString()); },
                        isRightAligned: false,
                        minWidth: 40,
                        ratio: 10,
                        title: "Quantity"
                    ...
                    {
                        collapseOrder: 6,
                        computeValue: (line: Entities.LegacySalesTransaction): string => { return emptyIfNull(line.Amount.toString()); },
                        isRightAligned: false,
                        minWidth: 40,
                        ratio: 10,
                        title: "Amount"
                    ...
                    {
                        collapseOrder: 5,
                        computeValue: (line: Entities.LegacySalesTransaction): string => { return emptyIfNull(line.Price.toString()); },
                        isRightAligned: false,
                        minWidth: 40,
                        ratio: 10,
                        title: "Price"
                    ...
                    {
                        collapseOrder: 4,
                        computeValue: (line: Entities.LegacySalesTransaction): string => { return emptyIfNull(line.Currency); },
                        isRightAligned: false,
                        minWidth: 50,
                        ratio: 10,
                        title: "Currency"
